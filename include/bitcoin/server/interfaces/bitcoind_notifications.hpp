 ...
 */
#ifndef LIBBITCOIN_SERVER_INTERFACES_BITCOIND_NOTIFICATIONS_HPP
#define LIBBITCOIN_SERVER_INTERFACES_BITCOIND_NOTIFICATIONS_HPP
...
struct bitcoind_notifications_methods
{
    ...
    using get_zmq_notifications = at<0>;
};
